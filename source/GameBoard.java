...
public class GameBoard
{
	...
	public void setComplex(ColorScheme theme)
	{
		this.complex = true;
                ...
                TargetChip redStar = new TargetChip(15, theme.getRed(), "assets/default/Red_Star_TC.png");
                TargetChip vortex = new TargetChip(16, theme.getLightGray(), "assets/default/Vortex.png");
                TargetChip greenAngledWall = new TargetChip(17, theme.getGreen(), "assets/default/Green_Angled_Wall.png");
                TargetChip blueAngledWall = new TargetChip(18, theme.getBlue(), "assets/default/Blue_Angled_Wall.png");
                TargetChip redAngledWall = new TargetChip(19, theme.getRed(), "assets/default/Red_Angled_Wall.png");
                TargetChip yellowAngledWall = new TargetChip(20, theme.getYellow(), "assets/default/Yellow_Angled_Wall.png");
                TargetChip greenAngledWall2 = new TargetChip(21, theme.getGreen(), "assets/default/Green_Angled_Wall.png");
                TargetChip blueAngledWall2 = new TargetChip(22, theme.getBlue(), "assets/default/Blue_Angled_Wall.png");
                TargetChip redAngledWall2 = new TargetChip(23, theme.getRed(), "assets/default/Red_Angled_Wall.png");
                TargetChip yellowAngledWall2 = new TargetChip(24, theme.getYellow(), "assets/default/Yellow_Angled_Wall.png");
                ...
                this.chips.add(greenAngledWall);

                this.chips = new ArrayList<>(Arrays.asList(greenSun, redMoon, yellowStar, blueSun, redPlanet, greenStar,
                 bluePlanet, greenPlanet, redSun, yellowPlanet, greenMoon, redStar, blueStar, yellowSun, vortex, greenAngledWall,redAngledWall,blueAngledWall,yellowAngledWall,greenAngledWall2,redAngledWall2,blueAngledWall2,yellowAngledWall2));
                ...
                this.grid[7][10].setTargetChip(vortex);
                this.grid[4][1].setTargetChip(greenAngledWall);
                this.grid[14][2].setTargetChip(blueAngledWall);
                this.grid[5][7].setTargetChip(yellowAngledWall);
                this.grid[11][7].setTargetChip(redAngledWall);
                this.grid[6][12].setTargetChip(greenAngledWall2);
                this.grid[9][12].setTargetChip(yellowAngledWall2);
                this.grid[1][13].setTargetChip(redAngledWall2);
                this.grid[11][14].setTargetChip(blueAngledWall2);
                ...
                this.grid[6][0].drawWall("WB");
                this.grid[9][0].drawWall("WB");
                this.grid[10][0].drawWall("SB");
                this.grid[9][1].drawWall("EB");
                this.grid[15][2].drawWall("SB");
                this.grid[1][2].drawWall("SB");
                this.grid[0][3].drawWall("EB");
                this.grid[7][4].drawWall("WB");
                this.grid[6][5].drawWall("NB");
                this.grid[9][4].drawWall("WB");
                this.grid[8][5].drawWall("NB");
                this.grid[12][5].drawWall("EB");
                this.grid[13][5].drawWall("SB");
                this.grid[13][6].drawWall("NB");
                this.grid[14][6].drawWall("WB");
                this.grid[2][5].drawWall("SB");
                this.grid[3][6].drawWall("WB");
                this.grid[3][7].drawWall("NB");
                this.grid[0][5].drawWall("SB");
                this.grid[1][9].drawWall("EB");
                this.grid[2][10].drawWall("NB");
                this.grid[0][10].drawWall("SB");
                this.grid[7][9].drawWall("SB");
                this.grid[8][10].drawWall("WB");
                this.grid[10][10].drawWall("NB");
                //this.grid[9][11].drawWall("WB");
                this.grid[12][10].drawWall("SB");
                this.grid[13][11].drawWall("WB");
                this.grid[13][12].drawWall("NB");
                this.grid[11][9].drawWall("WB");
                this.grid[4][12].drawWall("WB");
                this.grid[3][13].drawWall("NB");
                this.grid[2][13].drawWall("EB");
                this.grid[5][14].drawWall("SB");
                this.grid[6][15].drawWall("EB");
                this.grid[10][15].drawWall("EB");
                this.grid[10][10].drawWall("NB");
                this.grid[11][9].drawWall("WB");
                this.grid[9][12].drawWall("SB");
                this.grid[8][13].drawWall("EB");
                this.grid[5][13].drawWall("SB");
                this.grid[6][14].drawWall("WB");
                this.grid[15][12].drawWall("SB");
	...
	public void flipChip(ColorScheme theme)
	{
		...
		System.out.println("Chip index: " + chipInd);
		switch (chipInd)
		{
